  ...
  <div class="survey-layout">
    ...
    <div v-if="!hasStarted" class="welcome-screen">
      <div class="welcome-card">
        ...
        <p>Help us build a smarter AI by rating a few of our menu items. Your feedback directly shapes the future of our cafe!</p>
            ...
            <div class="sticky-card">
              ...
              <div class="item-cover">
                ...
                <div class="cover-info">
                  ...
                  <span class="badge">🍴 {{ currentItem?.category }}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="right-pane">
            <div class="questions-list">
              ...
              <div class="action-footer">
                ...
                <button
                  v-else
                  class="nav-btn success pulse-light"
    ...
    <Teleport to="body">
      <div v-if="showConfirmModal" class="modal-overlay">
        <div class="modal-card">
          ...
          <p>You have finished rating all 15 items! Click confirm to securely save your anonymous data and complete the survey.</p>
    ...
    <Teleport to="body">
      <div v-if="showSuccessModal" class="modal-overlay">
        <div class="modal-card">
          <div class="modal-icon">🎉</div>
          <h2>Amazing Job!</h2>
          <p>You have successfully submitted your responses. Your feedback is going to help us build a much smarter food AI. Thank you for your time!</p>
...
const menuItems = ref<any[]>([]); // Will strictly hold 15 items
...
// The magic shuffle function (Fisher-Yates algorithm)
...
const fetchMenuItems = async () => {
  try {
    ...
    // 1. Shuffle the entire menu
    shuffleArray(allItems);

    // 2. Slice exactly 15 items for this user!
...
// Submits all 15 items to the database at once
const executeFinalSubmit = async () => {
  try {
    ...
    // We can still use your /submit-category endpoint because it just accepts a list of answers!
...
.global-progress { font-size: 1.05rem; color: #64748b; }
.global-progress strong { color: #0f172a; font-weight: 800;}
...
.left-pane { position: sticky; top: 100px; }
...
.nav-btn.success { background: #10b981; color: white; margin-left: auto;}
.nav-btn.success:hover { background: #059669; }
